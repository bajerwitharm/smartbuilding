...
typedef enum __attribute__ ((__packed__)) {
	...
	telegram_wrong_fc_e = 0x04,
	telegram_wrong_size_field = 0x05,
} error_code_t;
...
//Test telegram: 0x7E 0x0A 0x0B 0xDF 0x0A 0x00 0x00 0xFF 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0xAB 0x7B (version 8 relay)
//Test telegram: 0x7E 0x0A 0x0B 0xDF 0x06 0x00 0x00 0x00 0x00 0xFF 0xFF 0xAB 0x7B (version 16 relay)
typedef struct __attribute__ ((__packed__)) {
	telegram_header_t header;
	actuator_t actuator;
} trigger_action_t;

//Test telegram: 0x7E 0x0A 0x0B 0xEA 0x00 0xAB 0x7B
typedef struct __attribute__ ((__packed__)) {
	telegram_header_t header;
	info_t info;
} get_info_t;
