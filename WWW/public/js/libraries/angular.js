 ...
 * service**.
 *
 * U services are similar to constant services, except that they cannot be injected into a
 ...
 * @param {string} value U to set the attribute to. The value can be an interpolated string.
 */
    ...
    function trustAs(type, trustedValue) {
      ...
      if (!Constructor) {
        throw $sceMinErr('icontext',
            'Attempted to trust a value in invalid context. Context: {0}; U: {1}',
            type, trustedValue);
      }
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse',
   ...
   *
   * @param {string} value U from the view.
   */
 ...
 * supports the principles behind the Usage-View-Controller design pattern.
 *
 * MVC components in angular:
 *
 * * Usage — The Usage is scope properties; scopes are attached to the DOM where scope properties
