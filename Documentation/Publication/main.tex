...
very little modification of off-the-self low cost routers to enable wide
...
based on Node.js server and AngularJS frontend and running on RaspberryPi
...
Nowadays, attention has turned towards protecting crucial network resources against the ''enemy within''. 


To effectively defend the network, even small, against internal threats user
authentication and access control is necessary. 

data loss prevention (DLP) systems, encryption, firewalls, IDS and anti-virus
packages – - See more at: http://www.information-age.com/technology/security/123458593/cyber-enemy-within-rise-insider-threat#sthash.lxBXm1qw.dpuf
